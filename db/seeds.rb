...
if root.valid?
  ...
  root.sections.build(name: 'quot_img', content: '<img src="/system/images/drova.jpg">')
...
if text_page.valid?
  ...
  page.section('quot_img').content = '<img src="/system/images/ughol.jpg">'
  page.save
  ...
  page.section('quot_img').content = '<img src="/system/images/briket.jpg">'
  page.save
  ...
  page.section('quot_img').content = '<img src="/system/images/drova.jpg">'
  page.save
end
